...
import type { Archetype } from "../entities/entity_archetype";
...
export class World {
    ...
    readonly entity_repo: EntityRepository = new Repository<Entity, EntityId, [string, Stats, Species, Archetype, Profession]>((id, name, max_stats, species, archetype, profession) => new Entity(id, name, none, max_stats, species, archetype, profession));
